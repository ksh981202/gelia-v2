              ...
              {styleOptions.map((s) => (
                ...
                >
                  ...
                  <div
                    ...
                    aria-hidden
                  />
                  <span className="absolute bottom-3 left-3 z-10 max-w-[85%] font-sans text-[15px] font-bold leading-snug tracking-tight text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.6)]">
