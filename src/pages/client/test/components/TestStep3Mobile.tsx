...
export default function TestStep3Page({ isProMode = false }: TestStep3MobileProps) {
  ...
  return (
    <div className="relative mx-auto flex h-full min-h-[100dvh] w-full max-w-md flex-col overflow-y-scroll overflow-x-hidden box-border bg-white pb-40 font-sans">
