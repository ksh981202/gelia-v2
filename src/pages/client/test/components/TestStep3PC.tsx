      ...
      <main className="flex-1 flex flex-col items-center justify-start pt-12 pb-8 px-6">
        <div className="w-full max-w-3xl bg-white border border-stone-200 rounded-2xl shadow-sm px-10 py-12 flex flex-col items-center">
          <div className="w-full max-w-xl mx-auto">
            ...
            <h2 className="mt-10 mb-1 whitespace-pre-line font-sans text-[22px] font-bold leading-snug tracking-tight text-gray-900">
              {isEnglish ? "Choose a color you like" : "끌리는 컬러를 선택해주세요"}
            </h2>
            <p className="mb-8 mt-2 font-sans text-[14px] font-medium tracking-tight text-gray-500">
              {isEnglish
                ? "Please choose the nail color chip that attracts you the most."
                : "가장 끌리는 네일 컬러 칩을 골라주세요."}
            </p>

            <div className="grid grid-cols-3 gap-x-4 gap-y-8 w-full box-border">
