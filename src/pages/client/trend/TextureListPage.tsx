  ...
  return (
    <div className="mx-auto min-h-screen max-w-md bg-white text-slate-900">
      ...
      <div className="sticky top-0 z-50 border-b border-gray-100 bg-white shadow-sm">
        ...
        <div className="relative flex items-center justify-between px-4 pb-3 pt-2">
          <span className="text-sm text-gray-500">
            총 <span className="font-bold text-pink-500">426</span>개의 디자인
          </span>
      ...
      <main className="grid grid-cols-2 gap-4 px-4 pb-[120px] pt-4">
        {[
          { id: 1, name: '하객 유니크 코랄 생화', img: 'https://picsum.photos/300/400?random=50' },
          { id: 2, name: '다크 프렌치 조개', img: 'https://picsum.photos/300/400?random=51' },
          { id: 3, name: '웨딩 핑크 조개', img: 'https://picsum.photos/300/400?random=52' },
          { id: 4, name: '올드머니 레드 시럽 글리터', img: 'https://picsum.photos/300/400?random=53' },
          { id: 5, name: '라벤더 마블 풀스톤', img: 'https://picsum.photos/300/400?random=54' },
          { id: 6, name: '발레코어 소라 치크', img: 'https://picsum.photos/300/400?random=55' }
        ].map((item) => (
