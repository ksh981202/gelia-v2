...
const DUMMY_ITEMS = [
  ...
  { id: 2, title: "심플 피치 마블", image: "https://images.unsplash.com/photo-1604654894610-df63bc536371?w=400&q=80" },
  { id: 3, title: "힙한 데이트 하트", image: "https://images.unsplash.com/photo-1522337660859-02fbefca4702?w=400&q=80" },
  { id: 4, title: "우아한 화이트 3D 하트", image: "https://images.unsplash.com/photo-1595950653106-6c9ebd614c3a?w=400&q=80" },
  { id: 5, title: "올드머니 생화", image: "https://images.unsplash.com/photo-1516975080661-460ce4178550?w=400&q=80" },
  { id: 6, title: "화려한 라벤더 스톤", image: "https://images.unsplash.com/photo-1505330592283-e14b8a213e48?w=400&q=80" },
];
      ...
      <div className="sticky top-0 z-50 border-b border-gray-100 bg-white shadow-sm">
        ...
        <div className="relative flex items-center justify-between px-4 pb-3 pt-2">
          <span className="text-sm text-gray-500">
            총 <span className="font-bold text-[#FF7E67]">20</span> 개의 디자인
          </span>
